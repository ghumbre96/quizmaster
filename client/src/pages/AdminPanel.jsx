...
export default function AdminPanel() {
  ...
  function addOptionAt(i){ setQuestions(qs => qs.map((q,idx)=> idx!==i ? q : ({...q, options:[...q.options, {id:crypto.randomUUID(), text:"", isCorrect:false}]}))); }
  ...
  return (
    <>
      ...
      <div className="card stack">
        ...
        <button disabled={!title || questions.length===0} className="btn btn-primary" onClick={save}>Save Quiz</button>
      </div>
    </>
  );
}
